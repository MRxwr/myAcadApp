<nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #012169 !important;">
				...
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.php" style="white-space: nowrap;">
							<img class="brand-img" src="../img/logo.png" alt="brand" style="width:25px;height:25px"/>
			...
			<div id="mobile_only_nav" class="mobile-only-nav pull-right" style="background: #012169;">
				<ul class="nav navbar-right top-nav pull-right">
					<li class="dropdown auth-drp">
						<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="../img/logo.png" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
