		...
		if( $fields = selectDB("fields_list","`status` = '0' {$id}") ){
			for( $i = 0; $i < sizeof($fields); $i++ ){
				...
				<td class="text-nowrap">
					...
					<a href="<?php echo "?v=Feild_Bookings&code={$fields[$i]["id"]}" ?>" class="btn btn-default" data-toggle="tooltip" data-original-title="<?php echo direction("Bookings","الحجوزات") ?>"> <i class="fa fa-list text-inverse m-r-10"></i></a>
					<a href="<?php echo "?v=Field_ManualBooking&code={$fields[$i]["id"]}" ?>" class="btn btn-success" data-toggle="tooltip" data-original-title="<?php echo direction("Manual Booking","حجز يدوي") ?>"> <i class="fa fa-plus text-inverse m-r-10"></i></a>
