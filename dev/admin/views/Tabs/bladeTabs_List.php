...
<div class="pull-left">
	<h6 class="panel-title txt-dark"><?php echo direction("Event Details","تفاصيل الحدث") ?></h6>
</div>
	...
	<form class="" method="POST" action="" enctype="multipart/form-data">
		<div class="row m-0">
			...
			<select id="mySelect4" name="tabId" class="form-control" required>
				<?php
				if( $TabsList = selectDB("tabs","`status` = '0' AND `hidden` = '0' ORDER BY `enTitle` ASC") ){
...
<div class="panel-heading">
<div class="pull-left">
<h6 class="panel-title txt-dark"><?php echo direction("List of Tournaments","قائمة البطولات") ?></h6>
</div>
<div class="clearfix"></div>
</div>
<div class="panel-wrapper collapse in">
