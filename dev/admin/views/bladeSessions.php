		...
		if( $sessions = selectDB("sessions","`status` = '0' AND `academyId` LIKE '{$_GET["code"]}' ORDER BY `{$orderBy}` ASC") ){
			for( $i = 0; $i < sizeof($sessions); $i++ ){
				...
				<td class="text-nowrap">
					<a href="<?php echo "?v=Session_Subscription&code={$_GET["code"]}&sessionId={$sessions[$i]["id"]}" ?>" class="subscribe btn btn-success" data-toggle="tooltip" data-original-title=""><?php echo direction("Subscriptions","الإشتراكات") ?></a>
