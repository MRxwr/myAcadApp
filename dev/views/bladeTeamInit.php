                    ...
                    <div class="col-lg-5 order-lg-1 mt_40">
                        ...
                        <input type="hidden" name="tournamentId" value="<?php echo $_GET["id"] ?>">
                            <div class="row">
                                ...
                                <div class="col-6 text-right p-3"><h5 style="color: black"><?php echo "({$tournament["bench"]}) " . direction("Players","اللاعبين") ?></h5></div>
                                <?php
                                ...
                                ?>
                                <div class="col-12 p-3 mb-5 button mt_55" id="submitTeam" ><?php echo direction("Continue","تابع") ?></div>
                            </div>
                        </form>
                    </div>
                </div>
