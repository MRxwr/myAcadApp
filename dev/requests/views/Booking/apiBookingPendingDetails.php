...
$dataJoin = array(
    ...
    "on" => ["t.fieldId = t1.id","t.ages = t2.id","t.levels = t3.id","t1.area = t4.id","t1.sport = t5.id","t1.facilities = t6.id"],
);
if( $pendingBooking = selectJoinDB("fields_booking", $dataJoin, "t.id = '{$data["id"]}'") ){
    $pendingBooking[0]["facilities"] = explode(",",$pendingBooking[0]["facilities"]);
