...
if( !isset($_POST) ){
    ...
    if( isset($data["fieldId"]) && !empty($data["fieldId"]) ){
        ...
        $postBody = array(
            ...
            'returnUrl' => 'https://dev.myacad.app/booking/index.php',
            'cancelUrl' => 'https://dev.myacad.app/booking/index.php',
            'notificationUrl' => 'https://dev.myacad.app/booking/index.php',
