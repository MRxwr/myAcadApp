...
if( !isset($_GET["tournamentId"]) || empty($_GET["tournamentId"]) ){
	...
	if( $tournament = selectDB2("`id`, `imageurl`, `enTitle`, `arTitle`, `area`, `video`, `location`, `price`, `players`, `bench`, `locationImage`, `enTerms`, `arTerms`, `gameDate`, `gameTime`","tournaments","`hidden` = '0' AND `status` = '0' AND `id` = {$_GET["tournamentId"]}") ){
