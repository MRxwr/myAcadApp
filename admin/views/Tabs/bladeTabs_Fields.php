...
<div class="pull-left">
	<h6 class="panel-title txt-dark"><?php echo direction("Fields Details","تفاصيل الحقول") ?></h6>
</div>
...
<div class="panel-heading">
<div class="pull-left">
<h6 class="panel-title txt-dark"><?php echo direction("Fields List","قائمة الحقول") ?></h6>
</div>
<div class="clearfix"></div>
</div>
<div class="panel-wrapper collapse in">
...
<div class="table-responsive">
	<table class="table display responsive product-overview mb-30" id="myTable">
		...
		<tbody>
		<?php 
		if( $personalInfo = selectDB("tabs_fields","`status` = '0' ORDER BY `rank` ASC") ){
