...
<div class="pull-left">
	<h6 class="panel-title txt-dark"><?php echo direction("Tab Details","تفاصيل التحويلة") ?></h6>
</div>
...
<div class="panel-heading">
<div class="pull-left">
<h6 class="panel-title txt-dark"><?php echo direction("List of Tabs", "قائمة التحويلات") ?></h6>
</div>
<div class="clearfix"></div>
</div>
<div class="panel-wrapper collapse in">
...
<div class="table-responsive">
	<table class="table display responsive product-overview mb-30" id="myTable">
		...
		<tbody>
		<?php 
		if( $sports = selectDB("tabs","`status` = '0' ORDER BY `rank` ASC") ){
