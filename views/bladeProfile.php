    ...
    <div class="left_side">
        <div class="profile_area">
            ...
            <ul>
                ...
                <li><a href="?v=Delete"><img src="img/img_8.svg" alt="" onclick="return confirm('<?php echo direction("Are you sure you want to delete your account?","هل أنت متأكد من حذف حسابك ؟") ?>')"><p><?php echo direction("Delete my account","حذف حسابي") ?></p></a></li>
            </ul>
        </div>
    </div>
    <div class="play_spt">
