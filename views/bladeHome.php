...
<div class="select_area">
    <div class="container">
        <form action="?v=Listing">
            ...
            <button class="select_btn mb_20" data-toggle="modal" data-target="#sport"><img id="sportMainImage" src="img/select_1.svg" alt=""><label id="sportMainTitle"><?php echo direction("SELECT SPORT","إختر الرياضة") ?><label></button>
