...
<div class="select_area">
    <div class="container">
        <form action="?v=Listing" method="post">
            ...
            <h2 style="padding-top:10px"><?php echo direction("SELECT YOUR ACADEMY!","إختر الأكادمية"); ?></h2>
            ...
            <div class="selet_wapper mb_20">
                ...
                <select class="select_btn select" name="gender" disabled>
                    <option disabled selected value="0"><?php echo direction("SELECT GENDER","إختر الجنس") ?></option>
            ...
            <button type="submit" class="button" id="homeBtnSubmit"><?php echo direction("Search","إبحث") ?></button>
        </form>
    </div>
</div>