...
if( !isset($_POST) ){
    ...
    */
    $response["msg"] = popupMsg($requestLang,'Please update the app from the store to proceed with payment -- الرجاء تحديث التطبيق من المتجر للمتابعت الدفع','خطأ في عملية الدفع');
    echo outputError($response);
}
?>